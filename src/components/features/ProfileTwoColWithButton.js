...
const TwoColumn = tw.div`w-3/4 flex flex-col justify-center md:flex-row justify-between max-w-screen-xl mx-auto pt-4 md:pt-4 items-center`;
...
const Links = styled.div`
  ...
  .link {
    ${tw`pr-10 mr-8 last:mr-0 text-gray-600 hocus:text-red-700 transition duration-300`}
    .icon {
